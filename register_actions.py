...
cmd = 'wsk action create image_process image_process.py --docker yz2297/python3_openwhisk --web raw -i --memory 256'
subprocess.call(cmd, shell=True)

os.chdir(str(top_dir / 'linpack'))
cmd = 'wsk action create linpack linpack.py --docker yz2297/python3_openwhisk --web raw --memory 256 -i'
subprocess.call(cmd, shell=True)

os.chdir(str(top_dir / 'matmult'))
cmd = 'wsk action create matmult matmult.py --docker yz2297/python3_openwhisk --web raw --memory 256 -i'
subprocess.call(cmd, shell=True)
...
cmd = 'wsk action create video_process video_process.py --docker yz2297/video_process_openwhisk --web raw -i --memory 256'
subprocess.call(cmd, shell=True)
