...
register_copy_function(func_dir = top_dir / 'chameleon', 
    ...
    image_prefix='sailresearch/chameleon_openwhisk', copies=copies, 
    memory_mb=256)
...
register_copy_function(func_dir = top_dir / 'pyaes', 
    ...
    image_prefix='sailresearch/pyaes_openwhisk', copies=copies, 
    memory_mb=256)
...
register_copy_function(func_dir = top_dir / 'video_processing', 
    ...
    image_prefix='sailresearch/video_process_openwhisk', copies=copies, 
    memory_mb=512)
...
register_copy_function(func_dir = top_dir / 'ml_inference' / 'logistic_regression_review', 
    ...
    image_prefix='sailresearch/lr_review_openwhisk', copies=copies, 
    memory_mb=256)
...
register_copy_function(func_dir = top_dir / 'ml_inference' / 'mobilenet', 
    ...
    image_prefix='sailresearch/mobilenet_openwhisk', copies=copies, 
    memory_mb=1024)